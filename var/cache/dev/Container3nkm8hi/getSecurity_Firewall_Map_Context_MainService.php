...
}, 5), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ${($_ = isset($this->services['security.authentication.trust_resolver']) ? $this->services['security.authentication.trust_resolver'] : ($this->services['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver('Symfony\\Component\\Security\\Core\\Authentication\\Token\\AnonymousToken', 'Symfony\\Component\\Security\\Core\\Authentication\\Token\\RememberMeToken'))) && false ?: '_'}, $c, 'main', ${($_ = isset($this->services['App\Security\LoginFormAuthenticator']) ? $this->services['App\Security\LoginFormAuthenticator'] : $this->load('getLoginFormAuthenticatorService.php')) && false ?: '_'}, NULL, new \App\Security\AccessDeniedHandler(), ${($_ = isset($this->services['monolog.logger.security']) ? $this->services['monolog.logger.security'] : $this->load('getMonolog_Logger_SecurityService.php')) && false ?: '_'}, false), $d, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.users', 'main', 'App\\Security\\LoginFormAuthenticator', 'App\\Security\\AccessDeniedHandler', NULL, [0 => 'guard', 1 => 'anonymous'], NULL));
