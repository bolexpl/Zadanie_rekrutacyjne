...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Form\\SurveyType' => function () {
    return ${($_ = isset($this->services['App\Form\SurveyType']) ? $this->services['App\Form\SurveyType'] : ($this->services['App\Form\SurveyType'] = new \App\Form\SurveyType())) && false ?: '_'};
